...
export interface TableColorChartData {
  records: DataRecord[];
  columns: string[];
}
export declare type TableColorChartFormData = QueryFormData & {
  align_pn?: boolean;
  color_pn?: boolean;
...
export interface TableColorChartProps extends ChartProps {
  ownCurrentState: {
    pageSize?: number;
    currentPage?: number;
  };
  rawFormData: TableColorChartFormData;
  queriesData: ChartDataResponseResult[];
}
export interface TableColorChartTransformedProps<
