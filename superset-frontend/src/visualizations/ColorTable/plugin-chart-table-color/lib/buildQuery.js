...
function getQueryMode(formData) {
  ...
  let cols = formData.all_columns.append(formData.color_column);
  const rawColumns = formData == null ? void 0 : cols;
...
const buildQuery = (formData, options) => {
  ...
  const sortByMetric = (0, _core.ensureIsArray)(
  ...
  if (queryMode === _core.QueryMode.raw) {
    formDataCopy = { ...formData, include_time: false };
  }

  return (0, _core.buildQueryContext)(formDataCopy, baseQueryObject => {
    var _options$ownState,
      _options$extras,
      _options$extras$cache,
      _options$extras2,
      _options$extras2$cach,
      _options$hooks2,
      _metrics2,
      _formData$extra_form_;
    ...
    if (queryMode === _core.QueryMode.aggregate) {
      ...
      if (sortByMetric) {
        ...
        ((_metrics = metrics) == null ? void 0 : _metrics.length) > 0
      ) {
      ...
      if (percentMetrics && percentMetrics.length > 0) {
        const percentMetricLabels = (0, _core.removeDuplicates)(
          percentMetrics.map(_core.getMetricLabel),
        );
        metrics = (0, _core.removeDuplicates)(
          metrics.concat(percentMetrics),
          _core.getMetricLabel,
        );
        postProcessing = [
          {
    ...
    const moreProps = {};
    const ownState =
      (_options$ownState = options == null ? void 0 : options.ownState) != null
        ? _options$ownState
        : {};
    ...
    if (formDataCopy.server_pagination) {
      ...
      moreProps.row_limit =
        (_ownState$pageSize = ownState.pageSize) != null
          ? _ownState$pageSize
          : formDataCopy.server_page_length;
      moreProps.row_offset =
        ((_ownState$currentPage = ownState.currentPage) != null
          ? _ownState$currentPage
          : 0) *
        ((_ownState$pageSize2 = ownState.pageSize) != null
          ? _ownState$pageSize2
          : 0);
    }
    ...
    if (
      ...
      options != null &&
      (_options$extras = options.extras) != null &&
      (_options$extras$cache = _options$extras.cachedChanges) != null &&
      _options$extras$cache[formData.slice_id] &&
      JSON.stringify(
        options == null
          ? void 0
          : (_options$extras2 = options.extras) == null
          ? void 0
          : (_options$extras2$cach = _options$extras2.cachedChanges) == null
          ? void 0
          : _options$extras2$cach[formData.slice_id],
      ...
      (0, _externalAPIs.updateExternalFormData)(
        options == null
          ? void 0
          : (_options$hooks = options.hooks) == null
          ? void 0
          : _options$hooks.setDataMask,
        0,
        (_queryObject$row_limi = queryObject.row_limit) != null
          ? _queryObject$row_limi
          : 0,
      );
    ...
    options == null
      ? void 0
      : (_options$hooks2 = options.hooks) == null
      ? void 0
      : _options$hooks2.setCachedChanges({
          [formData.slice_id]: queryObject.filters,
        });
    const extraQueries = [];

    if (
      (_metrics2 = metrics) != null &&
      _metrics2.length &&
      formData.show_totals &&
      queryMode === _core.QueryMode.aggregate
    ) {
      extraQueries.push({
        ...queryObject,
        columns: [],
    ...
    const interactiveGroupBy =
      (_formData$extra_form_ = formData.extra_form_data) == null
        ? void 0
        : _formData$extra_form_.interactive_groupby;
  ...
  return (formData, options) => {
    ...
    return buildQuery(
      { ...formData },
      {
        ...
        ownState:
          (_options$ownState2 = options == null ? void 0 : options.ownState) !=
          null
            ? _options$ownState2
            : {},
        hooks: {
