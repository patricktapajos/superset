...
export default function DataTable({
  ...
  const defaultGetTableSize = useCallback(() => {
    if (wrapperRef.current) {
      ...
      const height =
        ...
        (((_globalControlRef$cur = globalControlRef.current) == null
          ? void 0
          : _globalControlRef$cur.clientHeight) || 0) -
        (((_paginationRef$curren = paginationRef.current) == null
          ? void 0
          : _paginationRef$curren.clientHeight) || 0);
      return {
        width,
        height,
      };
  ...
  if (
    pageSizeRef.current[0] !== initialPageSize || // when initialPageSize stays as zero, but total number of records changed,
  ...
  if (serverPagination) {
    ...
    const serverPageSize =
      (_serverPaginationData = serverPaginationData.pageSize) != null
        ? _serverPaginationData
        : initialPageSize;
    ...
    resultCurrentPage =
      (_serverPaginationData2 = serverPaginationData.currentPage) != null
        ? _serverPaginationData2
        : 0;
