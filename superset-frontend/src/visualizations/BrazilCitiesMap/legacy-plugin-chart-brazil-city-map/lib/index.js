...
const metadata = new _core.ChartMetadata({
  ...
  description: '',
  name: (0, _core.t)('State Map'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true,
});

class StateMapChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () =>
        Promise.resolve().then(() =>
          _interopRequireWildcard(require('./ReactStateMap.js')),
        ),
      metadata,
...
exports.default = StateMapChartPlugin;
